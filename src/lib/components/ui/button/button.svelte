  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        default:
          'bg-background shadow-[0_4px_0_var(--border)] translate-y-[-6px] active:translate-y-[-2px] active:shadow-none hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 border',
      ...
      size: {
        ...
        xl: 'h-16 rounded-md px-6 has-[>svg]:px-4 text-2xl',
        icon: 'size-9',
      },
    },
    defaultVariants: {
