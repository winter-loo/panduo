  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        outline:
          'bg-background shadow-[0_4px_0_var(--border)] active:translate-y-[4px] active:shadow-none hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 border',
